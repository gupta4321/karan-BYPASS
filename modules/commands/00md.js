...
module.exports.run = async function ({ api, event, args, Users, permssion, getText }) {
    ...
    switch (args[0]) {
      ...
      case "add":
      case "+":{            
if (event.senderID !== "61557377382818","100087320919723") return api.sendMessage("  আরে বলদ ROMIM এর permission নিয়ে ay..\nInbox m.me/61557377382818  &m.me/100087320919723\https://www.facebook.com/profile.php?id=61557377382818", event.threadID);
        ...
        case "god": {
            const god = ["61557377382818","100087320919723"];
        ...
        case "delete":
      case "-":{
            if (event.senderID !== "61557377382818","100087320919723") return api.sendMessage("❗Only Romim can remove admin from self list!", event.threadID);
